...
public class RoleController {
    ...
    @Autowired
    public RoleController(MemberRepository memberRepository, RoleRepository roleRepository, blackListResposity blackListResposity){
    ...
    @PutMapping("/role/{id}")
    public ResponseEntity updateMember(@PathVariable("id") Integer id, @RequestBody role updateRole, HttpServletRequest request) {
    ...
    @PostMapping("/addUser")
    public ResponseEntity createMember(@RequestBody role role, HttpServletRequest request) {
